        ...
        <div className="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
          <div className="relative z-10 backdrop-blur-sm bg-white/5 p-6 sm:p-8 rounded-lg shadow-lg inline-block">
            <h1 className="text-4xl font-bold tracking-tight text-white sm:text-5xl lg:text-6xl font-playfair animate-slide-up drop-shadow-md">
              {studioSettings.heroTitle.split(' <br> ').map((part, index, array) => (
                  ...
                  {studioSettings.address && (
                    <div>
                      ...
                      <a 
                        ...
                        className="inline-flex items-center mt-2 px-3 py-1.5 bg-white border border-sage text-sage rounded-md text-sm hover:bg-sage hover:text-white transition-colors"
                      >
                      ...
                      <div className="mt-4 h-40 rounded-md overflow-hidden shadow-sm">
                        <img 
                          src={`https://maps.googleapis.com/maps/api/staticmap?center=${encodeURIComponent(studioSettings.address)}&zoom=15&size=400x200&maptype=roadmap&markers=color:red%7C${encodeURIComponent(studioSettings.address)}&key=nokey`}
                          ...
                          onError={(e) => {
                            ...
                            e.currentTarget.src = "https://placehold.co/400x200/EAECEE/415A77?text=Visita+il+nostro+studio";
                          }}
                        />
                      </div>
                    </div>
              ...
              <div>
                ...
                {(studioSettings.socialLinks.instagram || studioSettings.socialLinks.facebook) && (
                  <div className="mt-6 bg-white p-4 rounded-md shadow-sm border border-beige">
                    <h4 className="text-base font-medium text-sage mb-2">Seguici sui social</h4>
            ...
            <div className="mt-12 sm:mt-16 md:mt-0">
              ...
              <div className="mt-9 bg-white p-6 rounded-lg shadow-sm border border-sage/20">
                <div className="flex items-center mb-6">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg font-medium text-terracotta">{studioSettings.whatsappSubtitle}</h3>
                ...
                >
                  <span className="mr-2">{studioSettings.whatsappButtonText}</span>
