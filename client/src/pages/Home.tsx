        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <p className="mt-3 text-lg text-gray-600 max-w-2xl mx-auto">
              Hai domande o desideri maggiori informazioni sui nostri servizi fotografici per matrimoni? Contattaci su WhatsApp!
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-lg shadow border border-sage/20 flex flex-col md:flex-row items-center">
            ...
            <div className="md:ml-8 flex-1">
              <h3 className="text-xl font-medium text-terracotta mb-2">{studioSettings.whatsappSubtitle}</h3>
